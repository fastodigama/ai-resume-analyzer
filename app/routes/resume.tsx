...
import ATS from '~/componants/ATS'
    ...
    <main className="pt-0">
      <nav className="resume-nav">
        <Link to="/" className="back-button">
          ...
          <img src="/icons/back.svg" alt="logo" className='w-2.5 h-.25' />
      ...
      <div className="flex flex-row w-full max-lg:flex-col-reverse">
        ...
        <section className="feedback-section bg-[url(/images/bg-small.svg')] bg-cover h-screen sticky top-0 items-center justyfy-center ">
          {imageUrl && resumeUrl && (
